...
class _DashboardState extends State<Dashboard> {
  final BackendApi api = const BackendApi();
  bool loading = true;
  String? error;
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView(padding: const EdgeInsets.all(16), children: [
          ...
          const SizedBox(height: 8),
          Card(child: Padding(padding: const EdgeInsets.all(14), child: Text('資料缺失時採 NO BET，不以預設值冒充真實資料；5 星代表訊號強度，不代表保證命中率。', style: TextStyle(color: Colors.grey.shade300)))),
        ]),
      ),
    );
  }
